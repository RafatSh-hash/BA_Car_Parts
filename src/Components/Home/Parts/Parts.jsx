    ...
    return (
        <div className='mt-20 p-5'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-5 lg:grid-cols-7 gap-5 my-10'>
                <div data-aos="fade-right"  className='flex flex-col items-center justify-center rounded-md shadow-lg transition-all duration-500 hover:shadow-2xl p-3'>
                ...
                <div data-aos="fade-left" className='flex flex-col items-center justify-center rounded-md shadow-lg transition-all duration-500 hover:shadow-2xl p-3'>
                    <div className='w-36 h-36 pContainer'>
